...
def process_data(data):
    ...
    for item in data:
        ...
        # Calulate car year
        if item["car"]["car_year"] not in car_year_sales:
            car_year_sales[item["car"]["car_year"]] = 0
        
        car_year_sales[item["car"]["car_year"]] += item["total_sales"]

    # Get most car_year_sales year
    year = max(car_year_sales, key=car_year_sales.get)

    summary = [
        "The {} generated the most revenue: ${}".format(format_car(max_revenue["car"]), max_revenue["revenue"]),
        "The {} had the most sales: {}".format(format_car(max_sales["car"]), max_sales["total_sales"]),
        "The most popular year was {} with {} sales.".format(year, car_year_sales[year])
    ]
...
def cars_dict_to_table(car_data):
    ...
    for item in sorted(car_data, key=lambda x: x['total_sales'], reverse=True):
