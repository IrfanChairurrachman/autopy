...
def main(argv):
    ...
    # print(table_data)
    reports.generate("/home/irfancr/Practices/Bangkit/autopy/6_AutomatingRealTask/cars1.pdf", "Sales summary for last month", "<br/>".join(summary), table_data)
